        ...
        df.forEach((linhaNormalizada, index) => {
            ...
            if (!idEntrada) {
                ...
                db.entradas[idEntrada] = {
                    ...
                    DESCRICAO_ENTRADA_ORIGINAL: camposBasicos.DESCRICAO_ENTRADA_ORIGINAL !== undefined ? String(camposBasicos.DESCRICAO_ENTRADA_ORIGINAL).trim() : String(camposBasicos.DESCRICAO_ENTRADA || '').trim(),
            ...
            if (!idAcepcao && (defRaw || descRaw || exemplos.length > 0 || imagens.length > 0 || camposBasicos.ARQUIVO_VIDEO || temTextoEstruturado)) {
                ...
                db.significados[idAcepcao] = {
                    ...
                    TRADUCAO: defRaw,
                    DESCRICAO: descRaw,
                    DESCRICAO_ORIGINAL: camposBasicos.DESCRICAO_ORIGINAL !== undefined ? String(camposBasicos.DESCRICAO_ORIGINAL).trim() : descRaw,
                    METADADOS_EXTRAS: camposBasicos.METADADOS_EXTRAS || {},
                    EXEMPLOS_IDS: [],
                    IMAGENS_IDS: [],
                    VIDEOS_IDS: [],
